package com.luisbicho.dscommerce.controllers.it;
...
import com.luisbicho.dscommerce.util.TokenUtil;
...
public class ProductControllerIT {
    ...
    public void insertShouldReturnProductDTOCreatedWhenAdminLogged() throws Exception {
        ...
        result.andExpect(jsonPath("$.description").value("The best playstation ever and ever"));
        result.andExpect(jsonPath("$.price").value(600.0));
        result.andExpect(jsonPath("$.imgUrl").value("https://www.playstation.com"));
